      ...
      switch (data.type) {
        case "join":
          ...
          server.send(JSON.stringify({
            ...
            roomId,
            peers: []
            // Cannot track peers without Durable Objects
          }));
        ...
        case "cw_event":
          ...
          server.send(JSON.stringify(event2));
          break;
        case "leave":
...
// .wrangler/tmp/bundle-EyApZo/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-EyApZo/middleware-loader.entry.ts
